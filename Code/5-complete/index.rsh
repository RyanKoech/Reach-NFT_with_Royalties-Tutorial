  ...
  Reach.App(
    ...
    (Creator, Bidder, vNFT) => {
      Creator.only(() => {
          ...
          const royalty = (nftInfo.royalty >= 0 && nftInfo.royalty < 50)? nftInfo.royalty : 10;
          assert(royalty >= 0 && royalty < 50);
      });
      Creator.publish(id, deadline, nftInfo, royalty);
      ...
      while (keepGoing) {
        ...
        Bidder.publish(bid, winner)
          ...
          .timeout(relativeTime(deadline), () => {
            ...
            handlePayOut(royalty, price, Creator, owner);
